...
Before the deep read, load [the Phase 3 procedure](references/deep-read.md).
...
Use [the artifact formats](references/artifacts.md) for the draft.
...
[the artifact formats and placement rules](references/artifacts.md).
