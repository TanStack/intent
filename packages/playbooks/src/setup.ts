...
// Auto-generated by @tanstack/playbooks setup
// Exposes the playbook end-user CLI for consumers of this library.
// Commit this file, then add to your package.json:
//   "bin": { "playbook": "./bin/playbook.js" }
await import('@tanstack/playbooks/playbook-library')
`

function generateShim(root: string, result: SetupResult): void {
  const shimPath = join(root, 'bin', 'playbook.js')
...
export function runSetup(
  ...
  if (result.shim) {
    console.log(`✓ Generated playbook shim: ${result.shim}`)
    console.log(`\n  Add to your package.json:`)
    console.log(`    "bin": { "playbook": "./bin/playbook.js" }`)
    console.log(`\n  Add bin/playbook.js to your package.json "files" array.`)
  }
