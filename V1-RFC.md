...
> **Implementation status (verified 2026-07-05 against `main`; latest release `0.3.5`).**
>
> | Item                                                                    | Status                                                                                                                                                                                                                                                                           |
> | ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> | M2 — lockfile + frozen mode                                             | ⬜ not started (`intent.lock`, `lockfile.ts`, `hash.ts`, `mode.ts`, and `intent skills scan/approve/diff/update` are still absent; source identity tightening and pre-M2 trust guards have shipped)                                                                              |
